...
describe('Api.ts', () => {
  ...
  it('function: createI18NReport', () => {
    ...
    expect(report.missingKeys).toEqual([
      {
        file: path.resolve(__dirname, './fixtures/vue-files/file1.js'),
        language: 'de_DE',
        line: 2,
        path: 'missing.a',
      },
      {
        file: path.resolve(__dirname, './fixtures/vue-files/file2.js'),
        language: 'de_DE',
        line: 2,
        path: 'missing.b',
      },
      {
        file: path.resolve(__dirname, './fixtures/vue-files/file3.vue'),
        language: 'de_DE',
        line: 2,
        path: 'Missing',
      },
      {
        file: path.resolve(__dirname, './fixtures/vue-files/folder/file3.vue'),
        language: 'de_DE',
        line: 2,
        path: 'missing.c',
      },
      ...
      {
        file: path.resolve(__dirname, './fixtures/vue-files/folder/folder 2/file4.vue'),
        language: 'de_DE',
        line: 1,
